...
const rentalBookingRoutes = require('./modules/orders-rental/routes/rentalBookingRoutes');
...
const statusBarRoutes = require('./routes/statusBarRoutes');
...
app.use('/api/rental-calendar', rentalBookingRoutes);
...
app.use('/api/status-bar', statusBarRoutes);
