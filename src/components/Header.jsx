      ...
      <nav className="main-nav">
        <div className="container">
          <ul className="nav-list">
            ...
            <li className="hide-mobile"><Link to="/shop?category=parketna-doshka" className="nav-item">Паркетна дошка</Link></li>
            <li className="hide-mobile"><Link to="/shop?category=laminat" className="nav-item">Ламінат</Link></li>
            <li className="hide-mobile"><Link to="/shop?category=vinil" className="nav-item">Вінілова підлога</Link></li>
            <li className="hide-mobile"><Link to="/shop?category=dveri" className="nav-item">Двері</Link></li>
            <li className="hide-mobile"><Link to="/shop" className="nav-item">Стінові панелі</Link></li>
            <li className="hide-mobile"><Link to="/shop" className="nav-item">Аксесуари</Link></li>
