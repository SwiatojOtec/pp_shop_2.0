...
const CATEGORIES = [
    { id: 1, name: 'Паркетна дошка', image: imgParquet, link: '/magazyn/parketna_doshka' },
    { id: 2, name: 'Ламінат', image: imgLaminate, link: '/magazyn/laminat' },
    { id: 3, name: 'Підвіконня', image: imgDoors, link: '/magazyn/pidvikonnya' },
    { id: 4, name: 'Вінілова підлога', image: imgVinyl, link: '/magazyn/vinilova_pidloha' },
];
